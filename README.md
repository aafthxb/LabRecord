...
<div align="center">
**A beautiful, searchable, and interactive Programming
Lab Record.**<br> Organize programs by
language, search instantly, copy code, and run programs online --- all
...
Most Programming Lab Record websites require editing HTML, JavaScript,
or configuration files whenever you add a new program.

This project is different.

You simply organize your source files into folders, and everything else
...
From now on, you only need GitHub.

Whenever you upload, edit, or remove programs and commit the changes:
...
You only manage your program files.
...
> \[!IMPORTANT\] If you're using one of the languages above, **do not
> edit `languages.json`.**
>
...
```
  ...
  First Comment      Program Title
  ------------------ ---------------
  `// Bubble Sort`   Bubble Sort

  --------------------------------------------------------------------------------
  Second Comment                          Program Description
  --------------------------------------- ----------------------------------------
  `// Sort an array using Bubble Sort.`   Sort an array using Bubble Sort.
